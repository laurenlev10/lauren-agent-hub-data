...
def fetch_media_insights(media_id: str, metrics: _Optional[list] = None,
    ...
    Default metrics for Reels: shares, views, reach, likes, comments, saved, total_interactions (2026-05-20 — 'plays' deprecated in v22+).
    ...
    if metrics is None:
        metrics = ["shares", "views", "reach", "likes", "comments", "saved", "total_interactions"]  # 2026-05-20 — 'plays' removed in v22+, replaced by 'views'
    out = {}
